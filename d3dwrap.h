...
[[nodiscard]] auto MakeVertexBuffer() { return VertexBuffer{ nullptr, gVertexDeleter }; }
...
[[nodiscard]] auto MakeIndexBuffer() { return IndexBuffer{ nullptr, gIndexDeleter }; }
...
[[nodiscard]] auto MakeTexture() { return Texture{ nullptr, gTextureDeleter }; }

auto gEffectDeleter = [](ID3DXEffect* pEffect) { pEffect->Release(); };
typedef std::unique_ptr<ID3DXEffect, decltype(gEffectDeleter)> Effect;
[[nodiscard]] auto MakeEffect() { return Effect{ nullptr, gEffectDeleter }; }
...
[[nodiscard]] auto MakeSurface() { return Surface{ nullptr, gSurfaceDeleter }; }
...
[[nodiscard]] auto MakeVertexDeclaration() { return VertexDeclaration{ nullptr, gVertexDeclarationDeleter }; }
