...
[[nodiscard]] IDirect3DVertexBuffer9* loadVertexBuffer(
	IDirect3DDevice9* pDevice,
	const void* vertices,
	unsigned int vertexSize,
	unsigned int count,
	unsigned long vertexFVF
) noexcept;
...
[[nodiscard]] IDirect3DIndexBuffer9* loadIndexBuffer(
	IDirect3DDevice9* pDevice,
	const short* indices,
	unsigned int count
) noexcept;
...
[[nodiscard]] IDirect3DTexture9* loadTexture(
	IDirect3DDevice9* pDevice,
...
[[nodiscard]] ID3DXEffect* loadEffect(
	IDirect3DDevice9* pDevice,
	const wchar_t* filename
);
...
[[nodiscard]] IDirect3DVertexDeclaration9* loadVertexDeclaration(
	IDirect3DDevice9* pDevice,
